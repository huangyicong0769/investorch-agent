...
from investorch.agents import TokenUsage
...
class InvestOrchAgentTUI(App[None]):
    TITLE = "InvestOrch Agent"
    ...
    def compose(self) -> ComposeResult:
        yield Vertical(
            Horizontal(
                Label("InvestOrch Agent", id="brand"),
            ...
            try:
                ...
                async with self._timeline_lock:
                    ...
                    if session_id in self._known_session_ids:
                        ...
                        await timeline.add_notice("Ask InvestOrch Agent anything.")
                return
            except Exception:
